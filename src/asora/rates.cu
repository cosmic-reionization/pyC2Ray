...
// ========================================================================
__device__ double photoion_rates_gpu(double strength, double coldens_in,
                                     double coldens_out, double Vfact, double sig,
    ...
    if (abs(tau_out - tau_in) > TAU_PHOTO_LIMIT) {
        double phi_photo_out = prefact * photo_lookuptable(photo_thick_table, tau_out,
                                                           minlogtau, dlogtau, num_tau);
...
// ========================================================================
__device__ double photoion_rates_test_gpu(double strength, double coldens_in,
                                          double coldens_out, double Vfact,
                                          double sig) {
    // Compute optical depth and ionization rate depending on whether the cell is
    // optically thick or thin
    double tau_in = coldens_in * sig;
...
// ========================================================================
__device__ double photo_lookuptable(const double *table, double tau, double minlogtau,
                                    double dlogtau, int num_tau) {
    double logtau;
