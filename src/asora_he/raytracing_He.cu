                            ...
                            if ((coldens_in_hi <= MAX_COLDENSH) &&
                                ...
                                for (int nf = 0; nf < NumFreq; nf += 1) {
                                                                    ...
                                                                    // HeI and HeII
                                    {
                                        ...
                                        // total optical depth
                                        tau_in_tot =
                                            tau_in_hi + tau_in_hei + tau_in_heii;
                                        tau_out_tot =
                                    ...
                                    // TODO: heating requires more tables then just one
                                    // because of the frequency dependence. Probably
                                    // solution is to move this inside the if else
                                    // condition (look at the radionation_tables.f90
                                    // line 322)
