...
void do_all_sources_gpu(const double &R, double *coldensh_out, double *coldenshei_out,
                        ...
                        const int &NumSrc, const int &m1, const double &minlogtau,
                        const double &dlogtau, const int &NumTau);

// Raytracing kernel, called by do_all_sources
__global__ void evolve0D_gpu(
    const double Rmax_LLS, const int q, const int ns_start, const int num_src_par, const int NumSrc,
    int *src_pos, double *src_flux, double *coldensh_out, double *coldenshei_out,
    double *coldensheii_out, double *sig_hi, double *sig_hei, double *sig_heii, const double dr,
    const double *ndens, const double *xHI_av, const double *xHeI_av, const double *xHeII_av,
    double *phi_ion_HI, double *phi_ion_HeI, double *phi_ion_HeII, double *phi_heat_HI,
    double *phi_heat_HeI, double *phi_heat_HeII, const int m1, const double *photo_thin_table,
    const double *photo_thick_table, const double *heat_thin_table, const double *heat_thick_table,
    const double minlogtau, const double dlogtau, const int NumTau, const int nbin1,
    const int nbin2, const int nbin3, const int NumFreq, const int last_l, const int last_r);
