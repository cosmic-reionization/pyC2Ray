...
__global__ void evolve0D_gpu(
    ...
    const int NumSrc, int *src_pos, double *src_flux, double *rad_dir, double *angles,
    double *coldensh_out, const double sig, const double dr, const double *ndens,
    const double *xh_av, double *phi_ion, const int m1, const double *photo_thin_table,
