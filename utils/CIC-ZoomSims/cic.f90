...
!for ESMD
  fname='/store/clues/HESTIA/RE_SIMS/4096/DM_ONLY/37_11/output/snapdir_'//trim(adjustl(snc))//'/snapshot_'//trim(adjustl(snc))//'.0'
  fbase='/store/clues/HESTIA/RE_SIMS/4096/DM_ONLY/37_11/output/snapdir_'//trim(adjustl(snc))//'/snapshot_'//trim(adjustl(snc))//'.'
  
  !Save paths (fcic= cic path, fcoun= count in cell output, ferr= error file path)
  fcic='./hestia_3711_'//trim(adjustl(snc))//'.BCIC.'//trim(adjustl(nc))
  fcount='./hestia_3711_'//trim(adjustl(snc))//'.BCOUNT.'//trim(adjustl(nc))
  ferr='./hestia_3711_'//trim(adjustl(snc))//'.ERROR.'//trim(adjustl(nc))
...
!!$  fname='/store/multidark/SMD_3840_Planck1/SNAPS/snapdir_'//trim(adjustl(snc))//'/snap_'//trim(adjustl(snc))//'.0'
!!$  fbase='/store/multidark/SMD_3840_Planck1/SNAPS/snapdir_'//trim(adjustl(snc))//'/snap_'//trim(adjustl(snc))//'.'
!!$
!!$  fcic='/store/erebos/nil/SMD/SMD_3840_400Mpc_Plank1_'//trim(adjustl(snc))//'.BCIC.'//trim(adjustl(nc))
!!$  fcount='/store/erebos/nil/SMD/SMD_3840_400Mpc_Plank1_'//trim(adjustl(snc))//'.BCOUNT.'//trim(adjustl(nc))
