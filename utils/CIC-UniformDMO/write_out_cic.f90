subroutine write_out_cic(fcic,fcount,ferr)
  ...
  !end do
  write(35) count_grid
  print*, '  Minimum value of cic_grid_real: ', minval(count_grid)
  print*, '  Maximum value of cic_grid_real: ', maxval(count_grid)
  print*, 'First value: ', count_grid(1,1,1)
  print*, 'cic_grid(2,1,1): ', count_grid(2,1,1)
  print*, 'cic_grid(1,2,1) ', count_grid(1,2,1)
  print*, 'cic_grid(256,1,1) ', count_grid(256,1,1)
  print*, 'Last value: ', count_grid(ncells,ncells,ncells)
  print*, 'Sum: ', sum(count_grid)


  !deallocate(count_grid,count_grid_real)
  deallocate(count_grid)
