...
import pyc2ray
from evolve_pasc import evolve3D_pasc
from pyc2ray.utils.other_utils import get_extension_in_folder, get_redshifts_from_output, find_bins

from pyc2ray.utils import bin_sources
from pyc2ray.c2ray_base import C2Ray, YEAR, msun2g, m_p

from pyc2ray.source_model import StellarToHaloRelation, BurstySFR, EscapeFraction
...
class C2Ray_PASC(C2Ray):
    ...
    # =====================================================================================================
    def evolve3D(self, path_out, redshift, dt, src_flux, src_pos):
        ...
        if(NumSrc >= self.nprocs and self.mpi):
            self.xh, self.phi_ion, self.coldens = evolve3D_pasc(path_out=path_out, redshift=redshift, dt=dt, dr=self.dr,
    ...
    def ionizing_flux(self, file, z, dt=None): # >:( trgeoip
